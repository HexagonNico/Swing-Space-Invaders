...
public class Backgrounds {
	...
	public static void drawMainMenu(Graphics graphics, String[] options, int selected) {
		...
		graphics.drawString("SPACE", 22 * WindowManager.ZOOM, 30 * WindowManager.ZOOM);
		graphics.setColor(Color.GREEN);
		graphics.drawString("INVADERS", 123 * WindowManager.ZOOM, 30 * WindowManager.ZOOM);
		...
		graphics.drawImage(Resources.getTexture("aliens", 0, 0, 12, 8), WindowManager.WIDTH / 2 - 30 * WindowManager.ZOOM, 90 * WindowManager.ZOOM, 12 * WindowManager.ZOOM, 8 * WindowManager.ZOOM, null);
		graphics.drawImage(Resources.getTexture("aliens", 0, 8, 12, 8), WindowManager.WIDTH / 2 - 30 * WindowManager.ZOOM, 105 * WindowManager.ZOOM, 12 * WindowManager.ZOOM, 8 * WindowManager.ZOOM, null);
		graphics.drawImage(Resources.getTexture("aliens", 0, 16, 12, 8), WindowManager.WIDTH / 2 - 30 * WindowManager.ZOOM, 120 * WindowManager.ZOOM, 12 * WindowManager.ZOOM, 8 * WindowManager.ZOOM, null);
		graphics.drawImage(Resources.getTexture("red_ship"), WindowManager.WIDTH / 2 - 33 * WindowManager.ZOOM, 135 * WindowManager.ZOOM, 18 * WindowManager.ZOOM, 8 * WindowManager.ZOOM, null);
		graphics.setColor(Color.WHITE);
	...
	public static void drawGameOverScreen(Graphics graphics, int score) {
		...
		graphics.setColor(Color.WHITE);
		graphics.setFont(new Font("Arial", Font.BOLD, 22 * WindowManager.ZOOM));
		graphics.drawString("GAME", 22 * WindowManager.ZOOM, 30 * WindowManager.ZOOM);
